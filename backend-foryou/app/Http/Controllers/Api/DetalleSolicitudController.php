...
class DetalleSolicitudController extends Controller
{
     ...
     *     operationId="getDetallesSolicitud",
     ...
     * @OA\Post(
     *     path="/api/detalles-solicitud",
     *     operationId="createDetalleSolicitud",
     *     tags={"Detalles Solicitud"},
     ...
     *     operationId="getDetalleSolicitudById",
     *     tags={"Detalles Solicitud"},
     ...
     * @OA\Put(
     *     path="/api/detalles-solicitud/{id}",
     *     operationId="updateDetalleSolicitud",
     *     tags={"Detalles Solicitud"},
     ...
     * @OA\Delete(
     *     path="/api/detalles-solicitud/{id}",
     *     operationId="deleteDetalleSolicitud",
     *     tags={"Detalles Solicitud"},
